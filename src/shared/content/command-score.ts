/**
 * Taken integrally from the cmdk repo as we want to use the same scoring algorithm, but have some escape hatches
 * @url https://github.com/pacocoursey/cmdk/blob/main/cmdk/src/command-score.ts
 */
